...
/*   Updated: 2023/10/11 15:43:48 by tterao           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					t_vector3d intersection_pos)
{
	...
	const float			t = hit_object(shadow_ray_start, data->objs_list,
			shadow_ray, &obj) + (1.0f / C_EPSILON);
	const float			distance_to_light = vector3d_mag(vector3d_sub(
